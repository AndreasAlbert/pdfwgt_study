...
# with command line options: Configuration/GenProduction/python/B2G-Run3Summer19wmLHEGS-00017-fragment.py --fileout file:B2G-Run3Summer19wmLHEGS-00017.root --mc --eventcontent RAWSIM,LHE --datatier GEN,LHE --conditions auto:mc --step LHE,GEN --nThreads 8 --python_filename B2G-Run3Summer19wmLHEGS-00017_1_cfg.py --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/B2G-Run3Summer19wmLHEGS-00017-fragment.py nevts:500'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:@NAME.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:@NAME_inLHE.root'),
